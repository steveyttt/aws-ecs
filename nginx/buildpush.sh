...
docker tag nginx 366416047919.dkr.ecr.ap-southeast-2.amazonaws.com/nginx:latest
...
docker push 366416047919.dkr.ecr.ap-southeast-2.amazonaws.com/nginx:latest
